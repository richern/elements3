...
public enum PlayerState {
	...
	public boolean isOnWall() {
		return this == PlayerState.WALL_LEFT || this == PlayerState.WALL_RIGHT;
	}
	...
	public boolean isFacingLeft() {
		return this == PlayerState.IDLE_LEFT || this == PlayerState.WALK_LEFT
				|| this == PlayerState.WALL_LEFT || this == PlayerState.JUMP_LEFT;
	}
	
	public boolean isFacingRight() {
		return this == PlayerState.IDLE_RIGHT || this == PlayerState.WALK_RIGHT
				|| this == PlayerState.WALL_RIGHT || this == PlayerState.JUMP_RIGHT;
	}
}